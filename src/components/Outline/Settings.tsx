...
const Settings = () => {
  return (
    <div className="container ">
      ...
      <div className="lg:px-40 px-2 space-y-2">
        ...
        <section className="space-y-1">
          ...
          <section className="flex justify-center">
            <button className="bg-white p-2 text-[#805ad5] border-1 w-32 text-md font-semibold hover:border-[#805ad5] hover:bg-[#eae7ff] flex flex-col justify-center items-center rounded-l-lg space-y-1 transition duration-300 ease-in-out">
              <span>Short</span>
            </button>
            <button className="bg-white border-1 w-32 text-[#805ad5] text-md font-semibold hover:border-[#805ad5] p-2 hover:bg-[#eae7ff] flex flex-col justify-center items-center  space-y-1 transition duration-300 ease-in-out">
              <span>Medium</span>
            </button>
            <button className="bg-white p-2 border-1 w-32 text-[#805ad5] text-md font-semibold hover:border-[#805ad5] hover:bg-[#eae7ff] flex flex-col justify-center items-center rounded-r-lg space-y-1 transition duration-300 ease-in-out">
              <span>Long</span>
            </button>
          </section>
        </section>
